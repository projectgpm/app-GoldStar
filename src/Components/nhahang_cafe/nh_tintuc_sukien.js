...
class NH_TinTuc_SuKien extends Component {
    render() {
        return (
                ...
                <Content>
                    <View>
                        <List style={{ flex: 1, marginLeft: -17 }}>
                            {
                                this.props.arrTinTuc_NhaHang.map((item, index) => (
...
function mapStateToProps(state) {
    return {
        arrTinTuc_NhaHang: state.arrTinTuc_NhaHang,
    };
}

export default connect(mapStateToProps)(NH_TinTuc_SuKien);