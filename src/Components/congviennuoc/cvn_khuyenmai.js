...
class CVN_KhuyenMai extends Component {
    render() {
        return (
                ...
                <Content>
                    <View>
                        <List style={{ flex: 1, marginLeft: -17 }}>
                            {
                                this.props.arrKhuyenMai_CVN.map((item, index) => (
...
function mapStateToProps(state) {
    return {
        arrKhuyenMai_CVN: state.arrKhuyenMai_CVN,
    };
}

export default connect(mapStateToProps)(CVN_KhuyenMai);