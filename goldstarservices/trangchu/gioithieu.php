<?php
    ...
    if( $conn ) {
         $query='SELECT GioiThieuCongTy FROM tbl_cauhinh WHERE id = 1';
         ...
         if($result != null){
             ...
             $h1= '<!DOCTYPE html>
                        ...
                        <head>
                            ...
                            <link rel="icon" href="../../public/upload/user/CrhrY3FwNA_logo-cvn-300ppi-01-png.png" type="image/x-icon" />
                            <link rel="shortcut icon" href="../../public/upload/user/CrhrY3FwNA_logo-cvn-300ppi-01-png.png" type="image/x-icon">
            ...
            $h2 = '</div>
             ...
             echo $h1 . $row["GioiThieuCongTy"] . $h2;
